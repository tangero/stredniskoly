...
### Přidáno
- **Veletrh ve městě školy na stránce školy a stránku oboru** (`akceProObec()` ve `src/lib/veletrhy.ts`, komponenta `src/components/veletrhy/VeletrhUpoutavka.tsx`) — když se ve městě školy koná veletrh s potvrzeným termínem, ukáže se v oddílu „Kde je a okolí" stránky školy jako karta a v otázce „Co vám pomůže" stránky oboru jako položka seznamu; starší podoba stránky oboru ho dostává taky. Shoda je přesná (`mesto` akce = `obec` školy, ověřeno nad všemi městy zdroje), neváže se na seznam MESTA. Ukazuje se nejvýš 2 akce, jen potvrzené a neproběhlé. Text nikdy netvrdí, že se škola akce účastní — seznam vystavovatelů neexistuje v žádném zdroji — a věta o tom, že účast doložená není, je v obou variantách. Po skončení akce se blok skryje klientsky (`VeletrhSkryvani`), stránka se revaliduje hodinu. Zváženo a zamítnuto: online akce, přibližné termíny a záložní věta „veletrh ve vašem kraji" (zápis v `docs/zdroje-dat.md`, oddíl 2.15)

### Změněno
- Při jediném hodnocení maturity nad středem podobných škol se v textu uvádí jeho skutečný rok; údaj pak nelze zaměnit za rok poslední celkové maturity.
- **Maturitní souhrn za školu mluví o dostupných hodnoceních, ne o letech** (`jakCastoNadStredem`). Jednotkou souhrnu je hodnocení skupiny oborů v roce; škola hodnocená v jediném roce se už nevydává za „každý rok“, nové prahy mluví o hodnoceních („v jediném hodnoceném roce“, „ve všech hodnoceních“, „v téměř všech hodnoceních“, „ve většině hodnocení“, „v polovině hodnocení“, „jen v některých hodnoceních“, „v žádném hodnocení“). Výpočet podílu ani data se nemění. Rozložení obtížnosti na rozcestníku `/regiony` vypisuje počty všech pěti stupňů také textem, pruh je jen doplněk (`aria-hidden`); pořadí v kraji je na mobilu v čele řádku a chybějící pořadí se přizná („pořadí bez údaje“). Slovník ukazatelů 1.33, slovník pojmů 1.25
- **Přehled škol v kraji přestavěn nad souhrny zobrazeného ročníku** (`/regiony/[kraj]`, návrh `docs/navrh-stranky-kraje-2027.md`). Stránka dosud ukazovala ročník 2025, přestože registr vede 2026, 57 pražským oborům novým v roce 2026 dávala kapacitu 0 a „0,0× konkurence“ zeleně, hlavní sloupec „Nejnižší výsledek přijatých“ měla prázdný u všech řádků a výchozí řazení tvořilo žebříček napříč typy studia. Nově jedna karta na školu s jejími obory, u každého obtížnost přijetí, pozice na přihlášce, místa a přihlášky na místo; nahoře dva klikací pruhy (obtížnost, pozice na přihlášce), filtry typu studia, zřizovatele a okresu v adrese, řazení podle názvu a počtu míst a po výběru typu studia pořadí v kraji podle zájmu nebo výsledků přijatých. Karta školy nese řádek o maturitě za celou školu, odkaz na web školy a značku 2. kola
- **Kategorie oboru nahrazena doloženou kohortou podle pozice na přihlášce** (škola první volby, smíšená pozice, záložní volba). Stará kategorie („Vyvážený obor“) neměla doložený výpočet, první dva stupně stály na pevných prazích napříč typy studia a nové obory ji dostávaly napevno. Kohortu počítá `scripts/build-souhrny-kolo1.py` z percentilu podílu prvních voleb ve srovnatelné skupině; zobrazuje se na přehledu kraje, přehledu města a na stránce oboru, vždy bez semaforu a s větou, že neříká nic o kvalitě školy. Slovník ukazatelů 1.32, slovník pojmů 1.24
- **Přehled kraje zhuštěn do tabulky**: jeden řádek na školu, nejvýš dva řádky textu v buňce (obtížnost nejtěžšího oboru s rozsahem, počty oborů podle pozice na přihlášce, místa, maturita, po výběru typu pořadí v kraji). Obory a věty k nim jsou v detailu školy, viz `docs/navrh-stranky-kraje-2027.md`, oddíl 9
- **Vysvětlení pořadí v kraji na stránce kraje**: vysvětlivka „Co je pořadí v kraji podle výsledků přijatých?“ říká, jak se pořadí počítá (průměr celostátních percentilů přijatých, jen mezi obory stejného typu v kraji), proč percentil a ne body, co pořadí neříká a kdy se ukáže. Poznámka pod tabulkou ji otevře odkazem „Jak se pořadí počítá“, záhlaví sloupce má nápovědu. Přibyla i krátká vysvětlivka k pořadí podle zájmu
- **Rozcestník `/regiony`** ukazuje u kraje počet škol a nabídek a rozložení obtížnosti přijetí; žebříček „Top 10 oborů podle přihlášek“ s barevnou konkurencí odstraněn
- **Veletrhy: rešerše rozšířila přehled ze 41 na 77 zobrazitelných akcí** (`src/data/veletrhy-2027.json`, 95 záznamů místo 47) — Exa po krajích a Parallel FindAll, každý termín otevřen a ověřen na stránce. Nově burzy JHK (Tábor, Jindřichův Hradec, Písek, Strakonice, Blatná), Burzy práce a vzdělávání OHK v Olomouckém kraji, Moravskoslezsko (Frýdek-Místek, Nový Jičín, Karviná), Ústecko (Děčín, Rumburk, Chomutov, Litoměřice), Zlínsko (Uherské Hradiště, Vsetín, Kroměříž, Holešov) a další. Souhrnné záznamy sérií rozepsány na města; Opava a Kolín potvrzeny, Hitparáda doložena u pořadatele. Termín jen od vystavující školy nebo ze zpravodajství se nezobrazuje (8 akcí čeká s `cekaNa`); Parallel v jednom případě vydával loňský termín za letošní. Upoutávka na stránce školy uvádí datum ověření nejstarší zobrazené akce, ne datum poslední rešerše souboru
- **Rozesílka pořadatelům veletrhů neosloví stejnou adresu dvakrát** (`src/lib/veletrhy-oslovene.ts`) — dřív se hlídalo jen id adresáta, takže stejná adresa pod novým záznamem by dopis dostala znovu. Evidence oslovených adres se dosévá z rozesílky 23. 9.; oslovená adresa se z adresáta vyřadí, adresát bez nové adresy se přeskočí
...
### Opraveno
- **Code review PR #175 (veletrhy na stránce školy a rozesílka pořadatelům)**: upoutávka na stránce školy a oboru už neukazuje akce s termínem jen z agregátoru nebo přibližným (tvrdila u nich „Termín ověřen na webu pořadatele“, v rozporu s oddílem 2.15 zdrojů dat); nadpis karty „ve městě Příbram“ místo nesklonného „v Příbram“; varianta pro stránku oboru se po skončení akce skrývá stejně jako karta; prázdný obal s odsazením se u škol bez akce nevykresluje; rozesílka nepošle jedné adrese v jednom běhu dva dopisy (dva noví adresáti se stejnou adresou) a evidenci oslovených adres po jejím založení už nepřepisuje podle dnešního seznamu; dopis varianty bez termínu a varianty z agregátoru mluví u série akcí v množném čísle; den v klientské pojistce počítá sdílená `cesskyDen`, datum ověření sdílená `formatujDen`; opraveny komentáře s obrácenou podmínkou zobrazení
- **Code review PR #164**: katalog bez zobrazeného ročníku vrací `null` (stránka 404) místo tiše vykreslených „0 škol“; mobilní podoba přehledu kraje nese stejné údaje jako tabulka (doplněna maturita, značka 2. kola a doplněk obtížnosti); interaktivní vrstva má testy (řazení, filtry, round-trip adresy, stránkování a jeho zrušení popstate) nad zavaděčem s podstrčeným Reactem; `popstate` ruší i rozbalené stránkování; čipy filtrů a řazení mají `aria-pressed`; zástupné texty „bez údaje“ splňují kontrast; správné tvary „1 nabídka“; „také N.“ u pořadí předchozího ročníku se vztahuje i na velikost skupiny; škola bez okresu ve filtru okresů neplave pod obcí; `kohortaPozice` nepropustí neznámou hodnotu z dat; odstraněny mrtvé exporty (`CategoryCode`, `MIN_NABIDEK_VE_SKUPINE`); `poradiVKraji` a klíč 2. kola mají jednu definici sdílenou se stránkou oboru a přehledem města; `getKrajPrehled` a `nabidkyVeSkupineKraje` se cachují (metadata i stránka počítaly přehled dvakrát); historie slovníku ukazatelů 1.2 nezmiňuje kohortu, která vznikla až v 1.32
...
- **Slabiny obou modelů stojí vedle sebe.** U průběžného vedení je vypsané, že autor si schvaluje sám a že projekt stojí a padá s jedním člověkem; u zakázky, že nezávislá kontrola a odolnost proti odchodu člověka jsou skutečné přednosti. Poslední oddíl říká, pro co se který postup hodí, a že tenhle web by při převzetí státem potřeboval ten zakázkový
- **Řádový rámec z registru smluv** — 244 smluv veřejných institucí v IT se vztahem k portálům, informačním systémům a vzdělávání v pásmu 3 až 40 mil. Kč, celkem 2,9 mld., průměr 11,7 mil. Označeno jako hrubý filtr, ne srovnatelná skupina: množina obsahuje vývoj, provoz i licence. Bez jmenování konkrétních dodavatelů
...
- **Odpracovaný čas autora v oddílu „Kolik to stálo doopravdy“** — zhruba 200 hodin za 9 měsíců, s uvedením, že číslo nikdo nevykazoval a vychází z časových odstupů mezi 596 commity, a že to není čistý čas nad tímto webem, protože v týchž hodinách vznikal i jiný projekt. Nahrazuje dvě prázdná místa k doplnění. Vedle sebe pak stojí 200 hodin proti 3 176 hodinám dodavatelského týmu, s výhradou, že dělit jedno druhým a vydávat výsledek za míru úspory by bylo přehnané: obě čísla jsou odhady
- **Počet měsíců vývoje se odvozuje z rozsahu changelogu** (`mesicuVyvoje`), ne napevno; počítá se z prvního a posledního klíče osy, aby měsíce bez vydání (červenec a srpen) nevypadly
- **Oprava odhadu podle rozboru 514 commitů** — čas se připsal commitům (mezera nad 90 minut začíná nové sezení) a rozdělil mezi funkční oblasti podle měněných souborů. Dvě zjištění se promítla do odhadu: **katalog ze 45 na 60 člověkodnů** (má nejvíc změn ze všech oblastí, ve 41 různých dnech napříč celým projektem, třetina z nich opravy) a **nový blok „Provoz, konfigurace a nasazení“ s 15 dny**, který v první podobě chyběl úplně, protože se nesoustředí v žádném adresáři a při inventuře podle složek se přehlédne (85 změn ve 27 dnech). Blok testů se zúžil z 20 na 15 dnů, protože nasazení z něj odešlo. Ostatní bloky zůstaly: naměřený čas říká, jak rychle práci odbyl model, ne jak dlouho by trvala týmu — dopravní dostupnost má 6 % naměřeného času a je přitom algoritmicky nejtěžší kus webu. Celkem 367 + 59 = 426 člověkodnů, 4,1 až 6,1 mil. Kč
- **Kontrolní poměr řádků na člověkoden se dopočítává** (`RADKU_NA_CLOVEKODEN`), ne píše napevno; po opravě bloků klesl ze 194 na 181, tedy blíž k běžné produktivitě
- **Odhad ceny vývoje jako rozepsaný model**, ne jedno číslo: třináct funkčních bloků s odhadem člověkodnů a zdůvodněním, režie vedení projektu, tři sazby a vypsané výhrady včetně té, že poměr 194 řádků na člověkoden je na horní hranici produktivity a odhad tedy spíš podhodnocuje. Vychází 397 člověkodnů a 3,8 až 5,7 mil. Kč. Skutečné náklady mají na stránce označená místa k doplnění, protože je nikdo neměřil
