> **Neplatný návrh, uložený jako podklad k pozdějšímu rozhodnutí.**
>
> Závazný je [Sledování škol a hromadná upozornění na změny](sledovani-skol-2027.md) — verze 1.2, podle které se už postavilo schéma událostí (`db/migrace/004-udalosti.sql`). **Tenhle dokument podle ní nepostupuje a nesmí se podle něj nic realizovat.**
>
> Vznikl souběžně ve větvi `docs/sledovani-skol-a-oboru` a do hlavní řady se nikdy nesloučil. Liší se v podstatné věci: verze 1.0 sledování **oboru** zamítla, tahle ho přidává s odůvodněním, že rodina se rozhoduje mezi obory, ne mezi školami. Zůstává tu proto, že ta úvaha nikde jinde zapsaná není a je k ní potřeba se vrátit.
>
> Uloženo 22. 9. 2026 beze změn obsahu. Rozpor mezi oběma dokumenty je otevřený.
