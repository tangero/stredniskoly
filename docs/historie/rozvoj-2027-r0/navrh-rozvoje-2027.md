...
Datum původního auditu: 11. září 2026, před obnovou dat.

**Aktualizace stavu 11. 9. 2026:** Kalendář a první obnova dat již byly dokončeny a nasazeny v PR #71. Níže uvedené počty, nedostatky a doporučení zachycují výchozí stav na commitu `c17d42e`; nejsou aktuálním seznamem nevyřešených chyb. Rozsah hotové dodávky uvádí [záznam obnovy](aktualizace-kalendar-data-2027.md), průběžný [stav rozvoje a schválené produktové volby](prd-muj-vyber-2027.md) jsou v PRD Mého výběru. Zbývající návrhy v tomto dokumentu nejsou automaticky schváleným implementačním plánem.
