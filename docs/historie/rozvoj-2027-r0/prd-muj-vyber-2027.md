...
- **Verze:** 0.3, pracovní návrh pro společnou diskusi.
- **Datum:** 11. 9. 2026.
...
**Další práce:** uzavřít otevřené otázky ovládání v rozhodovacím deníku, připravit identitu a stavy nabídky pro nové profily a následně realizovat pilot Mého výběru. D8 (živý náhled nebo snímek) a D4 (umístění pracovního pořadí) zůstávají otevřené; žádná varianta nebyla tímto přehledem nově schválena.
...
Před připojením dojezdovosti ověřit datum jízdních řádů a místo výuky. Před připojením simulátoru prověřit převody skóre a odvozování dalších školních kritérií. Žádný neprověřený výpočet pravděpodobnosti se nesmí stát doporučením v Mém výběru.
