...
Verze 1.1. Zpracováno 11. 9. 2026. Předmět: `docs/navrh-rozvoje-2027.md`, `docs/prd-muj-vyber-2027.md` (v0.3) a `docs/aktualizace-kalendar-data-2027.md`.

Stav: oponentní posudek k rozhodnutí, nikoli schválená změna zadání. Každý bod má uveden způsob ověření. Body označené **OVĚŘENO** jsem doložil spuštěním kódu nebo stažením zdroje; body označené **NÁZOR** jsou argumentace bez tvrdého důkazu.
...
Stavy bodů: `otevřeno`, `v řešení`, `vyřešeno`, `zamítnuto`, `neplatné` (výtka byla mezitím překonána vývojem).

Souhrn stavu k verzi 1.1:

| Stav | Počet | Body |
|---|---:|---|
| otevřeno | 8 | O-1, O-2, O-3, O-5, O-6, O-9, O-13, O-14 |
| vyřešeno | 3 | O-7, O-8, O-10 |
| zúženo | 1 | O-4 (zbytek přešel do O-13) |
| potvrzeno správné | 3 | O-11, O-12, + zásady v části D |
...
Aktualizováno pro verzi 1.1. Doporučení verze 1.0 rozdělit návrh na archiv a živé zásady se **ruší**, protože je autor vyřešil hlavičkou dokumentu (viz část C).
