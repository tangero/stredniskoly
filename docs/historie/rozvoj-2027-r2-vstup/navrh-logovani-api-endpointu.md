...
Verze 1.1. Zpracováno 11. 9. 2026. Stav: návrh k rozhodnutí, neimplementováno.

**Změna proti 1.0:** opraveno zjištění o runtime logách Vercelu (dotazoval jsem nesprávný projekt), doplněn stav Web Analytics a varianta Log Drain. Viz 1.2 až 1.4.
...
### 1.3 Alternativa: Log Drain

Nabídka projektu obsahuje volbu **Add Drain**, tedy odvádění logů do externí služby. To řeší retenci bez psaní vlastního kódu.

Neřeší však chybějící user agent v runtime logu. Pokud by drain posílal i požadavkové logy včetně hlaviček, byla by to cesta bez implementace; to je **neověřené** a záviselo by na plánu a typu drainu. Stojí za prověření dřív, než se začne psát vlastní modul, protože by mohlo ušetřit celý den práce.
