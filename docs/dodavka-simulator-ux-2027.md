...
Lokálně prošel TypeScript, build, cílený lint bez varování, 3 testy statistických helperů a 11 integračních kontrol. V prohlížeči ověřeno 20 karet na stránce, přechod 1–20 → 21–40, přepnutí na filtrované výsledky a reset po zrušení filtru. Mobil 390 px bez horizontálního přetékání. Veřejná přejímka: PR #80, merge `f25f774ad140c05af224ec5e61994784ca9ed33d`, Vercel `dpl_2hpwSNoJeo3nDmdriEZ3WeVLzWwk` READY s veřejnou doménou. Produkční prohlížeč ověřil úvodních 20 karet (první PORG), druhou stránku 21–40 s dalšími 20 kartami a přepnutí do filtrovaných výsledků po zadání „jazyky“.
