...
- [Využití nepoužitých dat](../docs/navrh-vyuziti-nepouzitych-dat-2027.md) — data uchazečů 2026 (chybí jen přepnutí registru), dobíhající obor (netýká se ani jedné nabídky), přijatí podle priority jako složení třídy; proč o absolventech data nemáme
