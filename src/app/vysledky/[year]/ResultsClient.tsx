            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-slate-400">
                  {r.zamereni && <span>{r.zamereni} · </span>}
                  {TYP_LABELS[r.school_type] ?? r.school_type} · {r.kraj}
                </div>
              </div>
          ...
          {filtered.map((r, i) => (
            ...
            >
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-slate-400">{r.zamereni && <>{r.zamereni} · </>}{TYP_LABELS[r.school_type] ?? r.school_type} · {r.kraj}</div>
              </div>
              <div className="text-right shrink-0">
